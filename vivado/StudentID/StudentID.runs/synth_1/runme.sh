...
HD_PWD='E:/Modelsim_Vivado/lab10_StudentID/vivado/StudentID/StudentID.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StudentID.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StudentID.tcl
