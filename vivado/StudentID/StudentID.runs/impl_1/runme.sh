...
HD_PWD='E:/Modelsim_Vivado/lab10_StudentID/vivado/StudentID/StudentID.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log StudentID.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source StudentID.tcl -notrace
